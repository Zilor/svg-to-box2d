...
/*!
    ...
    \class Log
    \brief Gestion des logs (en fait cette classe pourrait s'appeler LogManager, mais ce serait trop long à écrire pour saisir un log)
...
#
    ...
    */
    ...
    /*!
        \class LogLine
        \brief Une ligne à écrire dans les logs
    */
    class LogLine {
